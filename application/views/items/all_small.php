...
<table>
	...
	<form action='<?php echo base_url(); ?>items/edit_this/<?php echo $ed_data[0]['magazine']; ?>/<?php echo $ed_data[0]['id']; ?>/condensed' method="post" id="items_form">
...
<!-- ***************************  START PHP ITEM LAYOUT   *************************** -->
	...
	<?php 
		...
		foreach($items AS $row){
			...
			echo "<input type='hidden' value='".$row['paid_item']."' name='paid_item".$row['id']."' id='paid_item".$i."' >";
			...
			echo "<input type='hidden' value='".$row['current_number_of_eds']."' name='current_number_of_eds".$row['id']."' id='current_number_of_eds".$i."' >";


			echo "<input type='hidden' value='".$row['number_of_eds']."' name='number_of_eds".$row['id']."' id='number_of_eds".$i."' >";
